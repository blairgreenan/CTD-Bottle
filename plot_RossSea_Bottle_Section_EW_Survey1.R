...
# that were carried out over the EW section across Survey 1 of Ross Bank.
#
# load libraries
library(oce)
library(R.matlab)
...
# Create a subset for the NE-SW section over Ross Bank CTD casts 51-57
...
tiff("CTD51-57_bottle.tiff", width=6, height=6, units='in', res=1200, compression = 'lzw')
par(mfrow=c(3,2))
